...
> **Active initiative — multi-agent parallelization addon for AIMFP.**
> Planning is complete; implementation is next. Start at
> `docs/multi-agent/00-HANDOFF.md`, then `01-DESIGN.md` and
> `02-AIMFP-GIT-DIRECTIVES.md`. Core decision: InterComm stays AIMFP-agnostic
> (never reads AIMFP's DB); the Claude master session is the integration glue.
